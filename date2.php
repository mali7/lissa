...
<div id="status">
	...
	<input type="button" class="btn btn-primary btn-lg" value="Start " id="start_button" onclick="startRecordingAfterActive()" disabled/>
  <input type="button" class="btn btn-default btn-lg" id="stop_button" value="Stop " onclick="stopRecordingOnHangup()" disabled />
  <input type="button" class="btn btn-primary btn-lg" id="postfeedback" value="Post Analysis" onclick="postAnalysis()" />
  
  <input type = "text" class="btn btn-primary btn-lg" value="" placeholder="Key" id="keyNumber" style="width:290px">
...
function putspeech(){
	setInterval(function(){
		...
		xhr1.open('GET', "response.php?action=readspeech&keyNumber=1"+keyNumber, true);
		xhr1.send();
	},1000);
}
