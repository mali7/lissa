...
function vh_talkStarted (){
	if(firstSpeech != 1){
		/**  This is where the user's dialogue contribution takes place.
		  *  We want to replace this with our turn-taking heuristic. -PM 8/11/16
		  **/
		keydown(75);
		keyup(75);
		//showspeech.textContent = "NOT LISTENING";
	}
	firstSpeech=0;
}
