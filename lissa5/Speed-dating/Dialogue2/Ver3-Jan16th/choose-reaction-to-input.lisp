...
; e.g., (My crazy room is a room with video games) 
   1 (0 My crazy room is 1 a room 0)
...
; e.g., (What I like better in Rochester is that people are nice)
   1 (0 What I like better in Rochester is 0)
...
(READRULES '*reaction-to-question*
 ...
 '(1 (what city 0 want to move 0); reciprocal query
    2 (Well\, you like big cities in which one can find so many things to do\, maybe New York City \.) (100 :out)
   1 (what kind 2 home 2 want to live 0); reciprocal query
    2 (You prefer a modern appartment \, those kind of smart homes \.) (100 :out)
   1 (where would you live 2 money 0); reciprocal query
    2 (A home near a lake is your ideal home\.) (100 :out)
   1 (what 2 dream home 0); reciprocal query 
    2 (A big home in a silent area near enough to a beautiful lake is your ideal home \.)
      (100 :out)
   1 (what 2 crazy room 0); reciprocal query
    2 (Well\, you like a room full of all kind of video games \.) (100 :out)
   1 (where 2 grow up 0); reciprocal query
    ...
    2 (Your parents are always on the move\, so you're from nowhere in
       particular\.) (100 :out)
   1 (what 0 plans after 1 graduate 0); reciprocal query
    2 (You want to get your PhD \.) (100 :out)
   1 (what 2 dream job 0); reciprocal query
    2 (Your dream job is being a computer scientist \.) (100 :out)
