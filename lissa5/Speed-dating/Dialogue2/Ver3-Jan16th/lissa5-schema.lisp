...
?a1. (Me say-to.v you 
      '(Hello again\, its nice to see you\. We are going to pick up our conversation where we left off\. While we talk\, the system will continue giving you feedback in the same way it gave you feedback before\.
     ))
...
?a58. (Me say-to.v you
      '(Listen\, I think we need to finish for today\, but it has been great knowing you! Pleas click on the stop botton to end this conversation\. Bye!))
...
; the next user input.
;
 '((?a1. ; Hello again, its nice to see you. We are going to pick up our conversation
