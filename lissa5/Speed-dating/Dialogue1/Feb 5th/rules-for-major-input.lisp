...
(READRULES '*question-from-major-input*
 ...
 '(1 (0 you find 3 hard 0)
    ...
    2 (Do you find 4 hard ?) (0 :gist)
   1 (wh_ year 2 you 0); users sometimes miss part of "Comp. Sci. senior"
 ...
 '(1 (My major is 0)
   ...
   1 (My majors are 3 and 3 \.)
    ...
    2 (Those majors make for a pretty heavy course load!)
      (100 :out)
   1 (I have not decided on a major); assuming this is the extracted gist clause!
   ...
   1 (0 you find 3 hard ?)
    ...
    2 (Some of your major courses are tough\, but you mostly enjoy them.) 
      (0 :out)
   1 (what year 3 you 2 ?); users sometimes miss part of "Comp. Sci. senior"
    2 (You are a senior.) (0 :out)
   ;1 (You don\'t think you follow that\. But let\'s go on\.)
    1 (Interesting)
    (100 :out)
 ))
