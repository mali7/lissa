...
(READRULES '*reaction-to-question*
  ...
  ; for improvement!):
 '(1 (Do you find 0 academic-subject 0 hard 0); reciprocal query
    2 (5 requires hard work\, but you find it enjoyable\.) (100 :out)
      ; latency = 100 so that a second run may give different output;
    2 (Sure\, 5 isn\'t easy\, but it\'s fun for you\.) (100 :out)
   1 (What 2 you like about Rochester 0); reciprocal query
    2 (You don\'t know Rochester well enough to say what you like
       or dislike\.) (100 :out)
    2 (You're not too familar with Rochester yet\.) (100 :out)
   1 (What would you change 2 Rochester?); reciprocal query
    2 (You\'re not sure what you would change -- you just don\'t
       know Rochester well enough\.) (100 :out)
   1 (What is your favorite eatery in Rochester?); reciprocal query 
    2 (You\'ve heard about various places\, but haven\'t seen much\.)
      (100 :out)
    2 (You\'re still learning about various places to eat\.) (100 :out)
   1 (Have you been to the Dinosaur Barbecue?); reciprocal query
    2 (Well\, just in your imagination\.) (100 :out)
    2 (No\, but you\'ve been told about it\.) (100 :out)
   1 (0 you like watching 0); reciprocal query
    2 (You mostly like interacting with people\.) (100 :out)
    2 (You like watching science fiction movies\.) (100 :out)
   1 (What is your favorite movie?); reciprocal query
   ...
   1 (Where are you from?)
    2 (You\'re from a place I\'ve probably never heard of -- Maida Vale\.)
