...
(READRULES '*gist-clause-trees-for-input*
 '(1 (3 what 4 your major 0) 
   ...
   1 (2 what 2 your favorite restaurant 4 in Rochester 0)
    2 (*specific-answer-from-favorite-restaurant-input* 
       *unbidden-answer-from-favorite-restaurant-input*
       *thematic-answer-from-favorite-restaurant-input*
       *question-from-favorite-restaurant-input*) (0 :subtrees)
   1 (2 what 2 your favorite place 3 eat 3 in Rochester 0)
    2 (*specific-answer-from-favorite-restaurant-input* 
       *unbidden-answer-from-favorite-restaurant-input*
       *thematic-answer-from-favorite-restaurant-input*
       *question-from-favorite-restaurant-input*) (0 :subtrees)
   1 (2 what 4 is garbage plate 0)
   ...
   1 (2 what type of movies 4 you 1 like 0)
   ...
   1 (2 you 1 seen 2 star wars 0)
    2 (*specific-answer-from-star-wars-input*
	   *unbidden-answer-from-star-wars-input*
	   *thematic-answer-from-star-wars-input*
	   *question-from-star-wars-input*) (0 :subtrees)
