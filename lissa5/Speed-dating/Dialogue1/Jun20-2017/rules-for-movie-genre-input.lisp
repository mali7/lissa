(eval-when (load eval)
  ...
  (MAPC 'ATTACHFEAT
  '((movie-genre animation drama romance cowboy comedy comedies classic classics horror thriller indie
      foreign documentary independent romantic sci-fi 
	  action western musical Bollywood fantasy
	  animated adventure documentaries musicals French
	  silent anime suspense biopic biopics kids Disney)
	  (genre-dislike horror thriller action)
	  (comedy comedies)
	  (sci-fi science-fiction fiction sci)
 ...
 (READRULES '*specific-answer-from-movie-genre-input*
  '(1 (0 favorite 2 movie-genre 0)
	...
	1 (0 NEG 1 like 1 movies 0)
	 2 ((I have no favorite movie genre \.) (movie-genre)) (0 :gist)
	1 (0 movie-genre 0)
	 2 ((My favorite movie genre is 2 \.) (movie-genre)) (0 :gist)
	1 (0 3 0)
 ...
 (READRULES '*reaction-to-movie-genre-input*  
  '(1 (0 My favorite movie genre is romance \.)
    ...
    1 (0 My favorite movie genre is comedy \.)
	 2 (You like movies that make you laugh \.) (100 :out)
	1 (0 My favorite movie genre is drama \.)
	 2 (Oh\, You love drama too \.) (100 :out)
	1 (0 My favorite movie genre is animation \.)
	 2 (Oh\, you love animations \.) (100 :out)
	1 (0 My favorite movie genre is genre-dislike \.)
	 2 (Well\, You are not a big fan of 7 movies \.) (100 :out)
	...
	1 (0 My favorite movie genre is suspense \.)
	 2 (You especially like those low-budget horror films with lots of fake blood \.) (100 :out)
	1 (0 My favorite movie genre is cowboy \.)
	 2 (That\'s cool\. You haven\'t seen a lot of people who watch cowboy movies \.) (100 :out)
	1 (0 My favorite movie genre is sci-fi \.)
	 2 (You also like sci-fi movies where the computers take over \.) (100 :out)
	1 (0 My favorite movie genre is 1 \.)
	 2 (You haven\'t seen many 7 movies \.) (100 :out)
	1 (0 Nothing found 0)
