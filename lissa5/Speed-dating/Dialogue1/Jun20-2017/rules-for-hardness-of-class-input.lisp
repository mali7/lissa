...
(READRULES '*specific-answer-from-hardness-of-class-input*
  ...
  1 (0 no problem 0)
    2 ((I did not find my favorite class hard \.) (favorite-class difficulty)) (0 :gist)
  1 (0 a 1 bit 0)
    2 ((I did find my favorite class a little bit hard \.) (favorite-class difficulty)) (0 :gist)
  1 (0 yes 0)
  ...
  1 (0 no 0)
    2 ((I did not find my favorite class hard \.) (favorite-class difficulty)) (0 :gist)
  1 (0 3 0)
    2 ((Nothing found for whether the favorite class was hard \.) (favorite-class difficulty)) (0 :gist)
...
(READRULES '*thematic-answer-from-hardness-of-class-input*
 ...
 (READRULES '*reaction-to-hardness-of-class-input* 
   '(1 (I did not find 0 difficult 0)
       2 (It\'s good I enjoy what comes naturally to me \.) (100 :out)
    1 (I did find 0 a little bit difficult 0)
       2 (Well\, as long as I am enjoying something and surviving the rest\, it\'s all good!) (100 :out)
    1 (I did find 0 difficult 0)
      2 (Well\, as long as I am enjoying something and surviving the rest\, it\'s all good!) (100 :out)
    1 (0 nothing found 0)
	   2 (Well\, as long as I am enjoying something and surviving the rest\, it\'s all good!) (100 :out)
    ))
