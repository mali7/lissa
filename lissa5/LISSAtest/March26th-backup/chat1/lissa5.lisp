...
;(defun purify_func (user-gist-clauses)
;(if (and (eq (length user-gist-clauses) 1) (eq (caar user-gist-clauses) 'Nothing) (eq (cadar user-gist-clauses) 'found))
;   (return-from purify_func user-gist-clauses)
;   (purify_func1 user-gist-clauses))
;)
(defun purify_func (x)
