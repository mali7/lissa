(eval-when (load eval)
 (MAPC 'ATTACHFEAT
  '((anything nothing)
    (weather climate warm warmer cold colder snow hot hotter humid temperature)
	(lot lots much)
...
;;			(The biggest difference between my hometown and Rochester is 0)
 ...
 '(1 (0 weather 0) 
    ...
    1 (0 food 0) 
        2 ((The biggest difference between my hometown and Rochester is food \.)  (rochester-hometown-difference)) (0 :gist) 
    1 (0 culture 0) 
        2 ((The biggest difference between my hometown and Rochester is the culture \.)  (rochester-hometown-difference)) (0 :gist) 
    1 (0 3 0) 
 ...
 (READRULES '*unbidden-answer-from-rochester-hometown-difference-input*
	'(1 (0 what do you think 0)
      ...
      1 (0 what 3 is the biggest difference between 3 hometown 2 Rochester 0)
        2 (what is the biggest difference between your hometown and Rochester ?) (0 :gist)
      1 (0 from rochester 0) ; my hometown is rochester so skip the next question
         2 ((Nothing found for what I like better in Rochester \.) (like-better-in-rochester)) (0 :gist)
	  1 (0 hometown is rochester 0) 
         2 ((Nothing found for what I like better in Rochester \.) (like-better-in-rochester)) (0 :gist)
	  1 (0 grow 2 rochester 0) 
         2 ((Nothing found for what I like better in Rochester \.) (like-better-in-rochester)) (0 :gist)
		))
 ...
 '(1 (0 weather 0) 
   ...
   1 (0 a lot to do 0) 
     2 (Yeah\, there are always a lot of things to do in larger cities \.) 
	   (100 :out) 
   1 (0 social-environment 0) 
     2 (So I would experience a different social environment here \.) 
	   (100 :out) 
   1 (0 neighborhood 0) 
     2 (So I would experience a different neighborhood here \.) 
	   (100 :out) 
   1 (0 culture 0) 
     2 (So it is a chance for me to experience a different cultural environment here \.) 
	   (100 :out) 
   1 (0 3 0) 
     2 (Right \.) 
	   (100 :out) 
