...
?a1. (Me say-to.v you 
      '(Hi\, My name is LISSA\. It\'s an acronym for Live Interactive Social Skills Assistant. 
...
?a3. (Me say-to.v you
      '(I am a computer science student\. What about you?))
...
?a15. (Me say-to.v you     
      '(Among all courses I\'ve had I liked Artificial Intelligence the best! that was my favourite by far!))
?a16. (Me say-to.v you
...
?a36. (Me say-to.v you
      '(One thing I always wonder about are good places to eat \. 
	  You might not think it by looking at me\, but I think restaurants are just great\. 
	  I love to watch people enjoy their food\. 
	  I also love the way that every place has its own unique atmosphere\. 
	  It doesn\'t have to be fancy\. I also love those dirty spoon\, 
	  hole in the wall restaurants that have a really fun and cool vibe\. 
	  Could you tell me about your favorite place to eat here in Rochester?))
