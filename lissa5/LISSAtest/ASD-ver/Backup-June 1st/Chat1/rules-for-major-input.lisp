...
(eval-when (load eval)
  ...
  (MAPC 'ATTACHFEAT
        '(; New as of June 18/15:
          ...
          (science computer physics chemistry optics microbiology biology biological
          ...
          (social-science health history political business
                  ...
                  psych psychology sociology education international)
...
(READRULES '*specific-answer-from-major-input*
 ...
 '(1 (0 high school 0)
    2 ((My majors is high school \.) (study-major)) (0 :gist)
   1 (0 middle school 0)
    2 ((My majors is middle school \.) (study-major)) (0 :gist)
   1 (0 elementary school 0)
    2 ((My majors is elementary school \.) (study-major)) (0 :gist)
   1 (0 school 0)
    2 ((My majors is school \.) (study-major)) (0 :gist)
   
   1 (0 double major 2 academic-subject 2 academic-subject 0)
    2 ((My majors are 5 and 7 \.) (study-major)) (0 :gist)
   1 (0 I 4 academic-subject and 1 academic-subject 0)
    2 ((My majors are 4 and 7 \.) (study-major)) (0 :gist)
   1 (0 I 4 major-first-words academic-subject and 1 academic-subject 0)
    2 ((My majors are 4 5 and 8 \.) (study-major)) (0 :gist)
   ...
   1 (7 major-first-words academic-subject 0)
    2 ((My major is 2 3 \.) (study-major)) (0 :gist)
   1 (0 I am 5 academic-subject 0)
    2 ((My major is 5 \.) (study-major)) (0 :gist)
   1 (0 I\'m 5 academic-subject 0)
    2 ((My major is 4 \.) (study-major)) (0 :gist)
   1 (0 I am 5 major-first-words academic-subject 0)
    2 ((My major is 5 6 \.) (study-major)) (0 :gist)
   1 (6 I\'m 5 major-first-words academic-subject 0)
    2 ((My major is 4 5 \.) (study-major)) (0 :gist)
   1 (6 academic-subject 2 major 0)
    2 ((My major is 2 \.) (study-major)) (0 :gist)
   1 (6 major-first-words academic-subject 2 major 0)
    2 ((My major is 2 3 \.) (study-major)) (0 :gist)
   1 (6 major 2 academic-subject 0)
    2 ((My major is 4 \.) (study-major)) (0 :gist)
   1 (6 major 2 major-first-words academic-subject 0)
    2 ((My major is 4 5 \.) (study-major)) (0 :gist)
   1 (6 major-first-words academic-subject 0)
    2 ((My major is 4 5 \.) (study-major)) (0 :gist)
   1 (10 academic-subject 0) 
    2 ((My major is 2 \.) (study-major)) (0 :gist)
   1 (3 NEG nil nil 3)
    2 ((I have not decided on my major \.) (study-major)) (0 :gist)
   1 (0 3 0)
    2 ((Nothing found for my major \.) (study-major)) (0 :gist)
  ))
 ...
 '(1 (0 My major is 0)
    ...
    2 (0 humanities 0)
     ...
     3 (The humanities aren\'t your strong suit.)
       (100 :out)
    2 (0 science 0)
	  3 (0 computer science 0)
	     4 (Sounds like we\'re kindred spirits\.) (100 :out)
     3 (0 comp science 0)
	     4 (Sounds like we\'re kindred spirits\.) (100 :out)
     3 (0)
	   4 (Well\, it looks like we\'re both scientifically minded\.)
       (100 :out)
