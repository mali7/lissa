...
?a1. (Me say-to.v you 
      '(Hello again \, its nice to see you \. V are going to pick up our conversation where we left off\. 
	  While we talk\, the system will continue giving you feedback in the same way it gave you feedback before\.
     ))

?a2. (Me say-to.v you
      '(So I know we talked about Rochester before\. Have you thought about what city you\'d want to live\, when you grow up?))
...
;*****************************************************************
?a47. (Me say-to.v you
      '(Let\'s talk a little bit about your free time\. Do you like watching TV and 
...
;?a51. (Me say-to.v you
 ;     '(Have you ever thought about your future job? What is your dream job?))
...
?a60. (Me say-to.v you
      '(Listen\, I think we need to finish for today\, but it has been great knowing you! Please click on the stop botton to end this conversation\.))
?a61. (Me say-to.v you
      '(Bye\!))
