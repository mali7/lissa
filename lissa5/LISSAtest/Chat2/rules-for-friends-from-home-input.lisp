...
;;			(I am in touch with my friends from home 0)
 ...
 '(1 (0 yes 0) 
   ...
   1 (0 I 2 touch 0) 
        2 ((I am in touch with my friends from home \.)  (friends-from-home)) (0 :gist) 		
    1 (0 3 0) 
        2 ((nothing found for I am in touch with my friends from home \.)  (friends-from-home)) (0 :gist) 		
    ))
 ...
 (READRULES '*question-from-friends-from-home-input* 
    '(1 (0 do you 4 have 4 friend 0)
        2 (Do you have any friend ?) (0 :gist)
      1 (0 what 0 you 0)
        2 (Do you stay in touch with any of your friends from home ?) (0 :gist)
      1 (0 do you stay in touch 3 friends 0)
        2 (Do you stay in touch with any of your friends from home ?) (0 :gist)
      1 (0 how 0 you 0)
        2 (Do you stay in touch with any of your friends from home ?) (0 :gist)
    ))
 ...
 '(1 (0 not in touch 0) 
     2 (You understand \.) 
	   (100 :out) 
   1 (0 am in touch 0) 
     2 (That\'s great that I have contact with my home friends \.) 
	   (100 :out) 
   1 (0 3 0) 
     2 (You understand \.) 
	   (100 :out) 
