(eval-when (load eval)
 (MAPC 'ATTACHFEAT
  '((lot lots much many)
	...
	;;(friend friends)
	(weather warm warmer)
	(education university universities graduate baccalaureate school study college)
	(people lifestyle)
	(apply applied)
	))
...
;;			(The city is special for me 0)
 ...
 '(1 (0 lot 3 to do 0) 
    ...
    1 (0 education 0) 
        ...
        2 (0) 
	         3 ((The city is special for me because I can study there \.)  (special-about-city-want-to-move)) (0 :gist) 	
 ...
 '(1 (0 a lot of things to do 0)
      2 (Yeah\, that\'s great to find activities to do in free time \.) 
        (100 :out)
   1 (0 family 0)    
     2 (Yeah\, that\'s great to live close to my family \.) 
       (100 :out)
