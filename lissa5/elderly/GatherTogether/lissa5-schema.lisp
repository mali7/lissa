...
?a5. (Me say-to.v you '(What is the best part?))
...
?a9. (Me say-to.v you '(Are there other holidays you prefer?))
...
?a13. (Me say-to.v you '(Have you been to any weddings recently\, or other family gatherings?))
...
; the next user input.
;
 '((?a1. ; What do you usually do for holidays?
         ((What do you usually do for holidays ?)))
   (?a5. ; What is the best part?
         ((What is the best part of holidays ?)))
   (?a9. ; Are there other holidays you prefer?
         ((What holidays you would prefer ?)))
   (?a13. ; Have you been to any weddings recently, or other family gatherings?
...
;
 '((?a1. ; What do you usually do for holidays, like Thanksgiving?
         (holidays-activities))
   (?a5.  ; What is the best part?
         (holidays-best-part))
   (?a9.  ; Are there other holidays you prefer?
