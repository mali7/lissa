(eval-when (load eval)
  ...
  '((rochester-restaurant-t Tahou Tahou\'s  plate Barbecue Luck Rosita\'s town star)
    ...
    (restaurant-type-one Asian Chinese Mexican Japanese Italian Korean Peruvian Thai Ethiopian Indian Mediterranean Greek Cambodian German Polish Spanish) 
    (restaurant-type-two burger pizza grill grills) 
	(restaurant-type-three diner cafe)))
    
; phrases for gist extraction:

 (READRULES '*specific-answer-from-favorite-eatery-input*
   '(1 (0 rochester-restaurant rochester-restaurant-t 0)
	 ...
	 1 (0 3 0)
        2 ((Nothing found about my favorite place to eat \.) (Rochester-eateries)) (0 :gist)	
	))
       
       
 (READRULES '*thematic-answer-from-favorite-eatery-input*
    '())

 (READRULES '*unbidden-answer-from-favorite-eatery-input*
    '(1 (0 dinosaur 0)
 ...
 (READRULES '*question-from-favorite-eatery-input*
    '(1 (0 wh_ 1 you 0)
