...
?a5. (Me say-to.v you '(What do you like about Rochester?))
...
?a9. (Me say-to.v you '(And what do you not like about it?))
...
?a13. (Me say-to.v you '(Is there anything you would change?))
...
; the next user input.
;
 '((?a1. ; So how long have you been in Rochester?
          ((How long have you been in Rochester ?)))
   (?a5. ; What do you like most about Rochester?
          ((What do you like about Rochester ?)))
   (?a9. ; And what do you not like about it?
          ((What do you not like about Rochester ?)))
          ; ^^^^THIS INFO MAY HAVE BEEN SUPPLIED ALREADY
   (?a13. ; Is there anything you would change?
