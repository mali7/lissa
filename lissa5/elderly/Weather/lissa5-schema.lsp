...
?a5. (Me say-to.v you '(Can you tell me about the forecast for this evening?))
...
?a9. (Me say-to.v you '(What is your favorite kind of weather?))
...
; the next user input.
;
 '((?a1. ; What is the weather like outside?
          ((How is the weather outside ?)))
   (?a5. ; Can you tell me about the forecast for this evening?
          ((How is the weather forecast for this evening ?)))
   (?a9. ; What is your favorite kind of weather?
...
;
 '((?a1. ; How is the weather outside ?
          (how-is-weather))
   (?a5. ; How is the weather forecast for this evening ?
          (weather-forecast))
   (?a9. ; What is your favorite weather ?
          (favorite-weather))
   )); end of mapcar
