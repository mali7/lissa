...
?a5. (Me say-to.v you '(I\’ve taken some great road trips\. Have you ever taken a fun road trip?))
...
?a9. (Me say-to.v you '(Giving up driving because of my health was very hard\. 
...
;
 '((?a1. ; What do you remember about your first car?
   ...
   (?a5. ; Have you ever taken a fun road trip ?
          (road-trips))
   (?a9. ; How one can cope with giving up driving ?
          (giving-up-driving))
   )); end of mapcar
