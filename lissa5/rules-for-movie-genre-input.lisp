(eval-when (load eval)
  ...
  (MAPC 'ATTACHFEAT
  '((movie-genre animation drama romance comedy comedies horror thriller indie
 ...
 (READRULES '*reaction-to-movie-genre-input*  
  '(1 (0 My favorite movie genre is romance \.)
	...
	1 (0 My favorite movie genre is drama \.)
	 2 (Oh\, drama movies always make you cry \.) (100 :out)
	...
	1 (0 have no favorite movie genre 0 \.)
	 2 (well\, you strongly like science fiction \.) (100 :out)
	1 (0 Nothing found 0)
