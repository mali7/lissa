...
?a1. (Me say-to.v you 
      '(Now I would like to learn about your family and friends\. Do you live by yourself or with others?))
...
?a5. (Me say-to.v you '(How long have you lived there?))
...
?a9. (Me say-to.v you '(Do you have children or grandchildren?))
...
?a13. (Me say-to.v you '(What do you usually do for holidays\, like Thanksgiving?))

?a14. (You reply-to.v ?a13.)

?a16. (Me react-to.v ?a14.)

?a17. (Me say-to.v you '(What is the best part?))

?a18. (You reply-to.v ?a17.)

?a20. (Me react-to.v ?a18.)

?a21. (Me say-to.v you '(Are there other holidays you prefer?))

?a22. (You reply-to.v ?a21.)

?a24. (Me react-to.v ?a22.)

?a25. (Me say-to.v you '(Have you been to any weddings recently\, or other family gatherings?))

?a26. (You reply-to.v ?a25.)

?a27. (Me react-to.v ?a26.)

?a29. (Me say-to.v you
      '(Let\’s pause here so I can give you feedback\.))
...
; the next user input.
;
 '((?a1. ; Now I’d like to learn about your family and friends. Do you live by yourself or with others?
         ((Do you live by yourself or with others ?)))
   (?a5. ; How long have you lived there?
         ((How long have you lived there ?)))
   (?a9. ; Do you have children or grandchildren?
         ((Do you have children or grandchildren ?)))
   (?a13. ; What do you usually do for holidays, like Thanksgiving?
         ((What do you do for holidays ?)))
   (?a17. ; What is the best part?
          ((What is the best part of holidays ?)))
   (?a21. ; Are there other holidays you prefer?
          ((Are there other holidays you prefer ?)))
   (?a25. ; Have you been to any weddings recently, or other family gatherings?
          ((Have you been to any family gathering recently ?)))
   (?a29. ; Let\’s pause here so I can give you feedback.
...
;
 '((?a1. ; Do you live by yourself or with others?
         (live-alone))
   (?a5. ; How long have you lived there?
