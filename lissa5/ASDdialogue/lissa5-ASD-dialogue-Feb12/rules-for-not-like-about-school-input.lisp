...
(eval-when (load eval)
  (mapc 'attachfeat '(
    ...
    (bored boring)
    (kids classmates peers children)
    (friend friends buddies)
  ...
  (readrules '*specific-answer-from-not-like-about-school-input*
    '(1 (0 not 2 much to do 0)  
        2 ((I find myself bored in school \.) (school-dislike)) (0 :gist)
      1 (0 nothing 2 to do 0)  
        2 ((I find myself bored in school \.) (school-dislike)) (0 :gist)
      1 (0 bored 0)
        2 ((I find myself bored in school \.) (school-dislike)) (0 :gist)    
      1 (0 hard 0)
        2 ((I find the work difficult in school \.) (school-dislike)) (0 :gist)
      1 (0 bully 0)
        2 ((I don\'t like that I\'m bullied in school \.) (school-dislike)) (0 :gist)
      1 (6 school-subject teacher 0)
        2 ((I don\'t like my 2 teacher in school \.) (school-dislike)) (0 :gist)
      1 (7 teacher 0)
        2 ((I don\'t like my teacher in school \.) (school-dislike)) (0 :gist)
      1 (8 school-subject 0)
        2 ((I don\'t like 2 in school \.) (school-dislike)) (0 :gist)
      1 (0 kids 0)
        2 ((I don\'t get along with other kids in school \.) (school-dislike)) (0 :gist)
      1 (0 NEG 1 have 5 friend 0)
        2 ((I don\'t have many friends in school \.) (school-dislike)) (0 :gist)
      1 (0 anything 0)
        2 ((no opinion about what I do not like in school \.) (school-dislike)) (0 :gist)
      1 (0 not 1 really 0)
        2 ((no opinion about what I do not like in school \.) (school-dislike)) (0 :gist)   
      ))
