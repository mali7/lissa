...
(readrules '*reaction-to-assertion*
  '(1 (My name 0)
	...
	1 (0 not like school 0)
	  2 *not-like-school-schema* (0 :schema)
	1 (0 like school 0)
	  2 *reaction-to-like-school-input* (0 :subtree)
	1 (I\'ve been in Rochester 0)
	  2 *reaction-to-time-in-rochester-input* (0 :subtree)
	1 (0 dislike about school 0)
	  2 *reaction-to-not-like-about-school-input* (0 :subtree)
	1 (0 bullying me 0)
	  2 *reaction-to-bullied-input* (0 :subtree)
    ))
