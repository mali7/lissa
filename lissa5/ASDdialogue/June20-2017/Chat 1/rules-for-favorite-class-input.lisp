...
(eval-when (load eval)
  ...
  '(; This is an attempt based on PM's listing of UR courses;
    ...
    (business entrepreneur entrepreneurs entrepreneurship finance 
     ...
     managerial business)
    (cog-sci behavioral behavior cognitive cognition
     brain perception)
...
; phrases for gist extraction:
 ...
 '(1 (0 not 4 favorite 0)
    2 ((I do not have a my favorite class \.) (favorite-class)) (0 :gist)
   1 (0 don\'t 4 favorite 0)
    2 ((I do not have a favorite class \.) (favorite-class)) (0 :gist)
   ...
   1 (0 academic-subject academic-course 0); for slightly better coverage
    ...
    2 ((My favorite class was 2 3 \.) (favorite-class)) (0 :gist)
   1 (0 excercise 0)
    2 ((My favorite class was gym \.) (favorite-class)) (0 :gist)
 ...
 (READRULES '*unbidden-answer-from-favorite-class-input*
    '(1 (0 NEG 0 hard 0)
      ...
      1 (0 easy 0)
        2 ((I did not find my favorite class hard \.) (favorite-class difficulty)) (0 :gist)
	  1 (0 what 0 you 0)
       2 ((Skip the question about favorite class hard \.) (favorite-class difficulty)) (0 :gist)
      1 (0 how 0 you 0)
       2 ((Skip the question about favorite class hard \.) (favorite-class difficulty)) (0 :gist)
      1 (0 what 2 your favorite class 0)
        2 ((Skip the question about favorite class hard \.) (favorite-class difficulty)) (0 :gist)
      ))
 ...
 '(1 (0 my favorite class 1 4 \.)
    ...
    2 (0 challenging-subject 0)
     3 (That sounds pretty challenging to you!)
       (100 :out)
    2 (0 business 0)
    ...
    2 (0 literature 0)
     3 (So I am probably a big reader!)
       (100 :out)
	2 (0 excercise 0)
		3 (Oh\, I should be into activities then\.)   
			 (100 :out)
    2 (0 my favorite class was 4 \.); pick out topic, for default answer.
     3 (6 sounds like a very interesting subject\.)
       (100 :out)
   1 (0 not have 3 favorite 0)
    2 (Well\, I seem to enjoy my area off study as a whole though\.)
      (100 :out)
   
   1 (0 nothing found 0)
     2 (Yeah\, that\'s a cool subject\.)
      (100 :out)
