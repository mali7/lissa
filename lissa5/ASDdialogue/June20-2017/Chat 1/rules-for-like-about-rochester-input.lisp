...
; phrases for gist extraction:
 ...
 '(1 (0 like 3 weather 0)
   ...
   1 (0 like 1 lot 2 things 0) 
	2 ((I like a lot of things in Rochester \.) (like-rochester)) (0 :gist)
   1 (0 can not 1 pick 0) 
	2 ((I like a lot of things in Rochester \.) (like-rochester)) (0 :gist)
   1 (0 3 0) 
 ...
 '(1 (0 I like 0 \.)
     ...
     2 (0 festivals 0)
		...
		(100 :out)
	 2 (0 lot 0)
        3 (Yeah\, one can find a lot of fun things to do around \.)	
		(100 :out)
