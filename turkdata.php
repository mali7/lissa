...
<div name="mturk_info" id="mturk_info">
	<h5>The survey will appear once you have finished watching the video.</br></br> You must accept the "HIT" to submit the survey, otherwise your submission will not be recorded.</h5>
</div>

<form name='mturk_form' method='post'  style = "display:none" id='mturk_form' action='https://workersandbox.mturk.com/mturk/externalSubmit'>
			<input type='hidden' value='' name='assignmentId' id='assignmentId'/>
			
			<h4>Please rate the quality of the negotiators.</h4>
			<input type="radio" name="quality" value="terrible">Terrible<br>
			<input type="radio" name="quality" value="okay">Okay<br>
			<input type="radio" name="quality" value="great">Great<br>
			
			<h4>What kind of attributes does the negotiator have. Check all that apply.</h4>
			<input type="checkbox" name="attributes" value="confident">Confident<br>
			<input type="checkbox" name="attributes" value="informative">Informative<br>
			<input type="checkbox" name="attributes" value="persuasive">Persuasive<br>
...
function drawAllCharts() {
    ...
    myVid.addEventListener("timeupdate", function(){
		//console.log("here it is " + myVid.currentTime);
		//console.log("max me " + myVid.duration);
