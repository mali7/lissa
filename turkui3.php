...
<div id="videoContainer">
		...
		<!-- <video id="sessionVideo" width="640" style="max-width:100%" src="https://www.machinteraction.com/rocspeak/uploads/e9d933d95ccc17df107c1eb0344ec9e5_1-merge.webm"  type="video/webm" controls ></video>-->
		 <video id="sessionVideo" width="640" style="max-width:100%" src="<?php echo "jokesvid/$dataKey-merge.webm"; ?>"  type="video/webm" controls >
</div></div>
 
 <div class="col-lg-6">

 <div name="mturk_info" id="mturk_info">
	<h2>The survey will appear once you have finished watching the video.</br></br> You must accept the "HIT" to submit the survey, otherwise your submission will not be recorded. Please use Chrome, you may experience issues with other browsers.</h2>
	<div name="mturk_info2" id="mturk_info2"></div>
</div>

 <form name='mturk_form' method='post'    id='mturk_form' action='https://www.mturk.com/mturk/externalSubmit'>
			<input type='hidden' value='' name='assignmentId' id='assignmentId'/>
		<h3>Rate all of the comments by their helpfulness to the speaker in the video for improve his/her speaking skills.</h3><h4>There are three categories of skills; Body Gestures, Friendliness, Volume Modulation.</h4>
