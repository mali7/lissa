  ...
  if (!('webkitSpeechRecognition' in window)) {
      ...
      recognition.onend = function() {
		...
		if (final_transcript.length > 0){
			if(recognizer_state==0){
				console.log("recognizer_state = "+recognizer_state);
				transcript_cache += final_transcript;
				final_transcript = "";
				interim_transcript = "";
				recognizer_state = 1;
				console.log("recognizer_state = "+recognizer_state);
				setTimeout(function(){
					if(interim_transcript == ""){
						//nothing spoken in last one sec
...
function alertRecognitionProgress() {
	alert('transcript: ' + interim_transcript);
	setTimeout(alertRecognitionProgress, 10000);
}
