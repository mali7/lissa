...
function initialize() {
  ...
  documentElement.getElementById('postfeedback').style.visibility="hidden";
...
function findkey(){
	...
	var xhr = new XMLHttpRequest();
			xhr.onreadystatechange = function() {
				console.log("key response "+this.readyState+" status = "+this.status+"  "+this.responseText);
				if (this.readyState == 4) {
					if (this.status == 200) {
					console.log("key response1");
